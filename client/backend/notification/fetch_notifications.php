<?php
// fetch_notifications.php - Fetch client notifications
...
try {
    ...
    // Get total count
    $count_query = "SELECT COUNT(*) as total FROM client_notifications $where_sql";
    ...
    // Get unread count
    $unread_query = "SELECT COUNT(*) as unread FROM client_notifications WHERE client_code = ? AND is_read = 0";
    $unread_stmt = $conn->prepare($unread_query);
    $unread_stmt->bind_param("s", $client_code);
    $unread_stmt->execute();

  ...
  const tenantManager = new DataManager({
    ...
    columns: [
      {
        field: "tenant_id",
        label: "Tenant ID",
        render: (it) => `<strong>${it.tenant_id}</strong>`,
      },
      {
        field: "fullname",
        label: "Tenant Name",
    ...
    populateDetails: async function (tenant) {
      ...
      body.innerHTML = `
                ...
                <tr><td><strong>Tenant ID</strong></td><td><input type="text" id="edit_tenant_id" value="${
                  tenant.tenant_code
                }" readonly></td></tr>

                <tr><td><strong>First Name</strong></td><td><input type="text" id="edit_firstname" value="${
                  tenant.firstname
                }"></td></tr>

                <tr><td><strong>Last Name</strong></td><td><input type="text" id="edit_lastname" value="${
                  tenant.lastname
                }"></td></tr>

                <tr><td><strong>Email</strong></td><td><input type="email" id="edit_email" value="${
                  tenant.email
                }"></td></tr>

                <tr><td><strong>Phone</strong></td><td><input type="text" id="edit_phone" value="${
                  tenant.phone
                }"></td></tr>
                ...
                <tr><td><strong>Allocated Property</strong></td>
                    <td>
                        <select id="edit_tenantProperty" class="select2"></select>
                    </td>
                </tr>

                <tr><td><strong>Allocated Apartment</strong></td>
                    <td>
                        <select id="edit_tenantApartment" class="select2" disabled></select>
                    </td>
                </tr>

                <tr><td><strong>Lease Start</strong></td><td><input type="date" id="edit_lease_start" value="${
                  tenant.lease_start_date || ""
                }"></td></tr>
                <tr><td><strong>Lease End Date</strong></td><td><input type="date" id="edit_lease_end" value="${
  ...
  try {
        ...
        .addEventListener("click", () => {
          UI.confirm("Are you sure you want to update this tenant?", () => {
            this.updateItem(tenant.tenant_id, {
              ...
              security_deposit: document.getElementById("edit_security_deposit")
                .value,
    ...
    onInit: function () {
      ...
      form?.addEventListener("submit", (ev) => {
        ...
        formData.append(
          "unit_id",
          document.getElementById("tenantPropertyUnit").value
        );
        formData.append(
          "lease_start_date",
        ...
        formData.append(
          ...
          document.getElementById("rentPaymentFrequency").value
        );
        formData.append(
          "next_payment",
          document.getElementById("nextPayment").value
        );

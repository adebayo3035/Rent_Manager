...
const mobileLogoutButton = document.getElementById('mobileLogoutButton');
   ...
   const accordionBtns = document.querySelectorAll('.mobile-accordion-btn');
    ...
    const mobileLinks = document.querySelectorAll('.mobile-nav-link:not(.mobile-accordion-btn)');
    ...
    function updateNotificationBadge(count) {
        const badges = document.querySelectorAll('.badge, .badge-menu, .mobile-notification-badge');
        ...
        fetch('../backend/authentication/navbar.php')
            ...
            .then(data => {
                if (data && data.unique_id) {
                    ...
                    const welcomeElements = document.querySelectorAll('#welcomeMessage, #mobileWelcomeMessage');
